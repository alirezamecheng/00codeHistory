...
#/==============================================================================
#=
* version 05, code name: 05MRTKruger (1 change);
    1- Meq (equilibrium moments) are different from Gue equations impelimented in 04MRTone.

* version 04, code name: 04MRTGue (2 changes);
...
#/==============================================================================
#               defenition of constants and global variables
#/==============================================================================
...
const rc = [3, 4, 1, 2, 7, 8, 5, 6, 0];  # index of reversed velocity changed 0-->9
...
const resultsAddress = "/home/aghnia/Results/MRT_Two_$(Dates.format(now(),"YY.mm.dd.HH.MM"))_MRT2_Re($(Re))_Gr($(Nx1)_$(Ny1))_Uw($(uw_top))" # for Server
...
# MRT collision
function Coll_MRT!(rho, ux, uy, f, f_post, m, s)
...
function main()
    ...
    Lenght  = L # = N + 1;                       # For halfway Bondary Condition
        
    tauMRT  = 3*Lenght*uw_top/Re + 0.5;          # relaxation time for BGK
