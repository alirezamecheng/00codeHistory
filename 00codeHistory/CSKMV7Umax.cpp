...
#define BS                 1              //  grid size (increase BS for finer grids) 
#define MACH               0.39           //  Mach number (try the 0.025 - 0.10 range)
#define TestVisc           0.000837520938023436




//#define U                  (0.122474487) // equal mack
#define Re                 0.0          //  Reynolds nunber (try the 100 - 10,000 range)




#define StabilityRun	// if defined will break at MAX_UnSteady_Itteration
#define MAX_UnSteady_Itteration     100001         // Max ittertation 
...
#define d_iter_01          1  // error calc intervals
#define d_iter_02          1000000  // File Outputs intervals
#define d_iter_03          5000	 // showing error intervals
...
#define y_dim              BS*28	// originally 77
#define x_dim              BS*38	// originally 105
