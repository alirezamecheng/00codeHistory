...
#/==============================================================================
#=  
    * version 28 based on 27
        1- changes made to available determining the max U vs. viscosity.
        2- uncomment the break criteria to max MaxItteration.
        3- all prints has been vided.
...
const Max_U = ; # set the lid velocity
const Constant_viscosity = ; # set the viscosity in lattice units

const errorlimitation = 1.0e-5;
const ErrCalculationSteps = 1000;
const MAX_UnSteady_Itteration = 50000;
...
# const MethodName = "MRT_Lalle"            # MRT From lallemand2000 article MRT1
# const MethodName = "Pradipto"             # MRT From Pradipto2017 MRT2
# const MethodName = "MRT_EAslan";          # MRT From E.AslanI.Taymaz2014 MRT3
# const MethodName = "MRT_Guo2";            # MRT From Guo2014 MRT4

# const MethodName = "CMs_NON_Orthogonal";  # CMs. Non-Orthogonal Central Moments space

# const MethodName = "Cas_Geier"            # cascaded Central moments space CCMS1
# const MethodName = "Cas_Lalle";           # CascadedLBM From lallemand CCMS2
# const MethodName = "Cas_Chavez";          # CascadedLBM From Chavez-Madena CCMS3 
...
# --------------------------Other implimented methods ---------------------------

# const MethodName = "MRT_Guo";             # MRT From LBM01.c Guo book
# const MethodName = "MRT_Khatoon"          # proposed by Khatoonabadi OpenLB
...
const PrintSteps = 100000;                        # onley controls Results file output
...
const CenterlinePrintFrequency = 100000;
...
const uw_top    = Max_U; # Lid U. Velocity or top X velocity
...
#     tau::Float64     = 3*L*uw_top/Re + 0.5;      # relaxation time for BGK
        tau = 1/Constant_viscosity; # for Max U test
...
tauMRT = 1/Constant_viscosity; # for Max U test
...
tauCascade = 1/Constant_viscosity; # for Max U test
