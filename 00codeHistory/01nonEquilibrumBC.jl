...
const Nx = 399        # number of cells in the x-direction -1
const Ny = 399    # number of cells in the y-direction -1
const Re = 400.0
...
const DistributionFunctionsSumFrequency = 20000
...
const resultsAddress = "/home/aghnia/Results/SRT_Non_equilibrum_boundary_$(Dates.format(now(),"YY.mm.dd.HH.MM"))_SRT_Re($(Re))_Gr($(Nx1)_$(Ny1))_Uw($(uw_top))" # for Server
